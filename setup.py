...
if __name__ == '__main__':
    ...
    setup(
        ...
        install_requires=[
            'Django >4', 'requests >= 2.4', 'requests_futures >= 0.9.5',
            'lxml >= 3.4', 'six >= 1'
        ],
        url="https://github.com/KenWhitesell/django-4-cas-server",
        download_url="https://github.com/KenWhitesell/django-4-cas-server/releases/latest",
        zip_safe=False,
